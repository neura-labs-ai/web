				...
				<div className="mx-auto max-w-2xl lg:max-w-4xl">
					...
					<figure className="mt-10">
						<blockquote className="text-center text-xl font-semibold leading-8 text-zinc-300 sm:text-2xl sm:leading-9">
							<p>
								I've been using {SITE.NAME} for a few months now, and I'm blown away by
								how easy it is to integrate advanced AI functionality into my
								applications. The chatbot API is particularly impressive. I highly
								recommend {SITE.NAME} to any developer looking to add cutting-edge AI
